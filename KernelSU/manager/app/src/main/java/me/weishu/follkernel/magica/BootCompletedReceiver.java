package me.weishu.follkernel.magica;

import static me.weishu.follkernel.magica.AppZygotePreload.TAG;
...
import me.weishu.follkernel.ui.util.KsuCliKt;
...
public class BootCompletedReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (!Intent.ACTION_LOCKED_BOOT_COMPLETED.equals(action)
                ...
                && !"me.weishu.follkernel.magica.LAUNCH".equals(action)) {
            return;
        }
